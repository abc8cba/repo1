...
<form method="post" action="${pageContext.servletContext.contextPath}/LoginController" id="loginform">
        ...
        <tr>
         ...
         <tr>
             <td colspan="2" align="center">
                 ...
                 <a href="LoginController?method=forgot_password&csrfToken=${csrfTokenReq}">Forgot Password</a>
             </td>
        </tr>
        <tr>
